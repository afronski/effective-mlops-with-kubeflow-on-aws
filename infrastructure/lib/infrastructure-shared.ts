...
export class InfrastructureSharedStack extends Stack {
  ...
  constructor (scope: Construct, id: string, props: InfrastructureSharedProps) {
    ...
    const repository = new Repository(this, "CodeRepository", {
      ...
      description:
        "Source code for 'Effective MLOps with Kubeflow on AWS' " +
    ...
    // Exporting HostedZoneId as SSM Parameter for the stack in the different region.

    new StringParameter(this, "HostedZoneIdForKubeflowPlatformSubdomain", {
      parameterName: CROSS_REGION_PARAMETERS.HOSTED_ZONE_ID,
